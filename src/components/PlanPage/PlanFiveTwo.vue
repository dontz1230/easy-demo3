<template>
  <div class="plan-section plan-section-three-four">
    ...
    <div class="planTitle">
        ...
        <div class="planTitle__redIcon" data-red="評估機構內部移動住民的方式（如單人搬運法、雙人搬運法等）以及外部撤離所需使用到之移動工具。
移動工具包含各類輔具器材（如擔架、輪椅、推床、爬梯機等）。">
     ...
     <textarea name="" id="" cols="30" rows="10"></textarea>
      ...
      <div class="planTitle">
        ...
        <div class="planTitle__redIcon" data-red="詳實記錄機構現有各類移動工具數量或可調度之數量，可調度之移動工具建議於平時與可配合之單位簽訂契約，並確保大規模災害時，資源調度的可行性。">
          <i class="fas fa-question"></i>
        </div>
      </div>
     <textarea name="" id="" cols="30" rows="10"></textarea>
